...
namespace API.Migrations
{
    ...
    [Migration("20210603021506_RoleRelations")]
    partial class RoleRelations
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AccountRoleRole", b =>
                {
                    b.Property<int>("AccountRoleNIK")
                        .HasColumnType("int");

                    b.Property<int>("RoleId")
                        .HasColumnType("int");

                    b.HasKey("AccountRoleNIK", "RoleId");
            ...
            modelBuilder.Entity("API.Models.AccountRole", b =>
                {
                    b.HasOne("API.Models.Account", "Account")
                        .WithOne("AccountRole")
                        .HasForeignKey("API.Models.AccountRole", "NIK")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
